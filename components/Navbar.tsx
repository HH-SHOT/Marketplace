...
const Navbar = () => {
    return(
        <div className="bg-white sticky z-50 top-0 inset-x-0 h-16">
            ...
            <MaxWidthWrapper>
                <div className="border-b border-grau-200">
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space">
                    ...
                    {user ? null : (<div className="felx lg:ml-6"><span className="h-6 w-px bg-gray-200" aria-hidden="true"></span></div>)}
